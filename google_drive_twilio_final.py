...
# TWILIO_AUTH_TOKEN = 'dd89cd8bc2f3ded7878150b7c7784051'
...
######################this is correct because it send msg on whatasup also##################
...
TWILIO_ACCOUNT_SID = 'ACa5421107e69fe1f668e0c624178753b4'
TWILIO_AUTH_TOKEN = 'dd89cd8bc2f3ded7878150b7c7784051'
TWILIO_PHONE_NUMBER = 'whatsapp:+14155238886'  # This must be your Twilio WhatsApp sender
RECIPIENT_PHONE_NUMBER = 'whatsapp:+919509920935'  # Must be registered in Twilio Sandbox
...
def send_whatsapp_message(message):
    ...
    approved_message = f"Your PPT is ready! Click here: {message}"

    try:
        msg = client.messages.create(
            body=approved_message,
            from_=TWILIO_PHONE_NUMBER,  # Must be enabled for WhatsApp in Twilio
...
if st.button("✨ Generate PPT & Send via WhatsApp"):
    if not (title and description and img1 and img2):
        ...
        send_whatsapp_message(drive_link)
